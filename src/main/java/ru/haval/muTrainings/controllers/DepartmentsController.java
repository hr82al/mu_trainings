...
public class DepartmentsController {
	...
	public String showDepartmentForm(Model model) {
	 ...
	 /* @GetMapping(path = "/department/{text}") 
	  public  String showByDepartmentForm(@PathVariable ("text") String text) { 
		  //List<Department> dpts = departmentsRepository.findByText(text); 
