...
const NEW_ROW_ITEM =
  '<tr class="id_positionName deleteEntry"><td><div></div></td><td><div class="itemPosition"></div></td><td><div class="itemTraining"></div></td><td><input type="checkbox" class="itemOptional"></td><td><input type="checkbox" class="itemDel"></td></tr>';
